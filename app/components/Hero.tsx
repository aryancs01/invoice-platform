        ...
        <section className="relative flex flex-col items-center justify-center">
            <div className="text-center">
                <span className="text-sm text-primary font-medium tracking-tight bg-primary/10 px-4 py-2 rounded-full">
                    Introducing InvoiceGenerate 1.0
                </span>
                ...
                <p className="mt-4 max-w-xl mx-auto lg:text-lg text-muted-foreground">Creating Invoices can be a pain! We at InvoiceGenerate make it super easy for you to get paid in time!</p>
